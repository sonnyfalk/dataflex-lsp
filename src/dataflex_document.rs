...
impl From<code_completion::CompletionItemKind> for lsp_types::CompletionItemKind {
    fn from(kind: code_completion::CompletionItemKind) -> Self {
        match kind {
            ...
            code_completion::CompletionItemKind::LocalObject => Self::INTERFACE,
            code_completion::CompletionItemKind::TopLevelObject => Self::INTERFACE,
            code_completion::CompletionItemKind::OtherObject => Self::INTERFACE,
