...
## Installing
The easiest way to install and use DataFlex-LSP for Visual Studio Code is to install the pre-built binary VSCode extension.
The latest pre-built binary release is [v0.8.5](https://github.com/sonnyfalk/dataflex-lsp/releases), download `vscode-dataflex-win32-x64-0.8.5.vsix` for Windows, or `vscode-dataflex-darwin-arm64-0.8.5.vsix` for macOS.
